...
namespace ConsoleApplication2
{
    class Environment
    {
        ...
        public Environment(int sPiecesNum_init, byte radius_int, byte windStr_init, double[] windDir_init, byte windStrFluc_init, double windDirFluc_init, double density_init, double gravitation_init, double C_coefficient_init, byte Scene_Height_init)
        {
